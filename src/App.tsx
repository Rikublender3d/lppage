  ...
  return (
    <>
      <div className="relative">
        ...
        <div className="relative">
          <div className="w-[100%] md:h-[80vh] h-[60vh] md:absolute bg-gradient-to-l from-[#8f94fb] to-[#4e54c8] z-10">
            <img src={bg} className='object-center object-cover w-full aspect-video circles overflow-hidden' />
          </div>
          <div className="hidden md:block md:h-[80vh] h-[60vh] flex justify-center items-center">
            <h2 className='md:absolute left-1/24 top-1/12 bg-gray-700 bg-clip-text text-4xl font-bold text-transparent z-20'>ホワイトニングってどれを選ベばいいのかわからない</h2>
            <h2 className='md:absolute right-1/50 top-2/5 bg-gray-700 bg-clip-text text-4xl font-bold  text-transparent z-20'>最近歯が黄ばんできた…</h2>
            <h2 className='md:absolute left-1/12 bottom-1/12 bg-gray-700 bg-clip-text text-4xl font-bold  text-transparent z-20'>マスクを外すと急に口元が目立つようになった</h2>
          </div>
        </div>
        <div className="md:hidden text-left flex flex-col justify-evenly items-left w-[95%] mx-auto">
        ...
        <MdOutlineKeyboardDoubleArrowDown className='w-20 h-20 mx-auto my-5 animate-bounce' />
        <div className='flex justify-center items-center'>
          <img src={docter} className='object-center object-cover ' />
          <h2 className="object-center text-[#595757] text-4xl font-bold text-center px-4 pb-3 pt-5">国家資格を持つ歯科医師・歯科衛生士にお任せください。
          </h2>
        </div>
        ...
        <h2 className="text-[#595757] text-4xl font-bold text-center px-4 pb-3 pt-5">キースおとなこども歯科の
        こだわり</h2>
        ...
        <h2 className="text-[#595757] text-4xl font-bold text-center px-4 pb-3 pt-5">料金一覧</h2>
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(228px,1fr))] gap-2.5 px-4 py-3 @3xl:grid-cols-4">
          <div className="flex flex-1 flex-col gap-4 rounded-xl border border-solid border-[#dce0e5] bg-white p-6">
            <div className="flex flex-col gap-1">
              ...
              <span className="text-[#111418] text-4xl font-black leading-tight tracking-[-0.033em]">0yen</span>
            </div>
            <button
        ...
        <div className="flex flex-col gap-8 overflow-x-hidden bg-white md:px-20 px-10">
          <div className="flex flex-col gap-3 bg-white">
            ...
            <p className="text-[#111418] text-base font-normal leading-normal">
              1回の施術だけで、2トーンぐらい白くなり満足です。今まで歯磨き粉ジェルやセルフホワイトニングの機会を使用していましたが、こちらでお願いするのと効果が全く違いますね。
              明るい印象になりました。LINEから予約できるのが嬉しいです。              </p>
          </div>
          <div className="flex flex-col gap-3 bg-white">
            <div className="flex items-center gap-3">
              <div
            ...
            <p className="text-[#111418] text-base font-normal leading-normal">
              先日初めてのホワイトニングで行きました！女性のスタッフさんが丁寧に説明、ご対応くださり終始居心地いい空間でした。ここでホワイトニングデビューしようと思います！よろしくお願いいたします。
            </p>
          </div>
          <div className="flex flex-col gap-3 bg-white">
            <div className="flex items-center gap-3">
            ...
            <p className="text-[#111418] text-base font-normal leading-normal">
              理想の歯の色になるまでのアドバイスや、プランなど親身になって提案してくれました。1回でも白くなっているのが驚きでした！
              また継続的に行きたいと思います。素敵な接客にありがとうございました。
            </p>
          </div>
        </div>
